...
void EmitSop1(Translator& t, const Inst& inst) {
  ...
  switch (op) {
    case 0x03: t.SetSg(sdst, a); break;  // s_mov_b32
    case 0x04:                           // s_mov_b64
      t.SetSg(sdst, a);
      t.SetSg(sdst + 1, a_hi);
      break;
    ...
    case 0x0a:  // s_wqm_b64
      ...
      break;
    case 0x0b: t.SetSg(sdst, t.BitRev(a)); break;  // s_brev_b32
    ...
    case 0x17: {  // s_flbit_i32: leading-sign-bit count; -1 if src is 0 or -1
      const Id smsb = t.m.Bitcast(
          t.t_u, t.m.ExtInst(t.t_i, GLSLstd450FindSMsb, {t.m.Bitcast(t.t_i, a)}));
    ...
    default: WarnUnsupported("sop1", op); break;
  }
}
...
void EmitSop2(Translator& t, const Inst& inst) {
  ...
  switch (op) {
    ...
    case 0x09:  // s_max_u32
      ...
      break;
    case 0x0a: r = t.SelectNz(t.Scc(), a, b); break;  // s_cselect_b32
    case 0x0b:                                        // s_cselect_b64
      r = t.SelectNz(t.Scc(), a, b);
      r_hi = t.SelectNz(t.Scc(), a_hi, b_hi);
      break;
    case 0x0e: r = t.And(a, b); scc = true; break;  // s_and_b32
    case 0x0f: r = t.And(a, b); r_hi = t.And(a_hi, b_hi); scc = wide_scc = true; break;
    case 0x10: r = t.Or(a, b); scc = true; break;   // s_or_b32
    case 0x11: r = t.Or(a, b); r_hi = t.Or(a_hi, b_hi); scc = wide_scc = true; break;
    case 0x12: r = t.Xor(a, b); scc = true; break;  // s_xor_b32
    case 0x13: r = t.Xor(a, b); r_hi = t.Xor(a_hi, b_hi); scc = wide_scc = true; break;
    case 0x14: r = t.And(a, t.Not(b)); scc = true; break;  // s_andn2_b32
    case 0x15: r = t.And(a, t.Not(b)); r_hi = t.And(a_hi, t.Not(b_hi)); scc = wide_scc = true; break;
    case 0x16: r = t.Or(a, t.Not(b)); scc = true; break;   // s_orn2_b32
    case 0x17: r = t.Or(a, t.Not(b)); r_hi = t.Or(a_hi, t.Not(b_hi)); scc = wide_scc = true; break;
    case 0x18: r = t.Not(t.And(a, b)); scc = true; break;  // s_nand_b32
    case 0x19: r = t.Not(t.And(a, b)); r_hi = t.Not(t.And(a_hi, b_hi)); scc = wide_scc = true; break;
    case 0x1a: r = t.Not(t.Or(a, b)); scc = true; break;   // s_nor_b32
    case 0x1b: r = t.Not(t.Or(a, b)); r_hi = t.Not(t.Or(a_hi, b_hi)); scc = wide_scc = true; break;
    case 0x1c: r = t.Not(t.Xor(a, b)); scc = true; break;  // s_xnor_b32
    case 0x1d: r = t.Not(t.Xor(a, b)); r_hi = t.Not(t.Xor(a_hi, b_hi)); scc = wide_scc = true; break;
    ...
    case 0x26: r = t.Mul(a, b); break;  // s_mul_i32
  ...
  if (r) {
    t.SetSg(sdst, r);
    if (r_hi) t.SetSg(sdst + 1, r_hi);
    if (scc) t.SetSccBool(t.IsNonZero(wide_scc ? t.Or(r, r_hi) : r));
  }
}
...
void EmitSopc(Translator& t, const Inst& inst) {
  ...
  Id c = 0;
  switch (op) {
    case 0x00: c = t.Eq(a, b); break;
    case 0x01: c = t.m.Emit(spv::Op::OpINotEqual, t.t_bool, {a, b}); break;
    case 0x02: c = t.m.Emit(spv::Op::OpSGreaterThan, t.t_bool, {ai, bi}); break;
    case 0x03: c = t.m.Emit(spv::Op::OpSGreaterThanEqual, t.t_bool, {ai, bi}); break;
    case 0x04: c = t.m.Emit(spv::Op::OpSLessThan, t.t_bool, {ai, bi}); break;
    case 0x05: c = t.m.Emit(spv::Op::OpSLessThanEqual, t.t_bool, {ai, bi}); break;
    case 0x06: c = t.Eq(a, b); break;
    case 0x07: c = t.m.Emit(spv::Op::OpINotEqual, t.t_bool, {a, b}); break;
    case 0x08: c = t.m.Emit(spv::Op::OpUGreaterThan, t.t_bool, {a, b}); break;
    case 0x09: c = t.Uge(a, b); break;
    case 0x0a: c = t.Ult(a, b); break;
    case 0x0b: c = t.Ule(a, b); break;
    ...
    default: WarnUnsupported("sopc", op); break;
  }
  if (c) t.SetSccBool(c);
}
...
void EmitSopk(Translator& t, const Inst& inst) {
  ...
  switch (op) {
    case 0x00: t.SetSg(sdst, imm_i); break;  // s_movk_i32
    case 0x02:                               // s_cmovk_i32
      t.SetSg(sdst, t.SelectNz(t.Scc(), imm_i, t.Sg(sdst)));
      break;
    case 0x03: cmp(spv::Op::OpIEqual, true); break;             // s_cmpk_eq_i32
    case 0x04: cmp(spv::Op::OpINotEqual, true); break;          // s_cmpk_lg_i32
    case 0x05: cmp(spv::Op::OpSGreaterThan, true); break;       // s_cmpk_gt_i32
    case 0x06: cmp(spv::Op::OpSGreaterThanEqual, true); break;  // s_cmpk_ge_i32
    case 0x07: cmp(spv::Op::OpSLessThan, true); break;          // s_cmpk_lt_i32
    case 0x08: cmp(spv::Op::OpSLessThanEqual, true); break;     // s_cmpk_le_i32
    case 0x09: cmp(spv::Op::OpIEqual, false); break;            // s_cmpk_eq_u32
    case 0x0a: cmp(spv::Op::OpINotEqual, false); break;         // s_cmpk_lg_u32
    case 0x0b: cmp(spv::Op::OpUGreaterThan, false); break;      // s_cmpk_gt_u32
    case 0x0c: cmp(spv::Op::OpUGreaterThanEqual, false); break; // s_cmpk_ge_u32
    case 0x0d: cmp(spv::Op::OpULessThan, false); break;         // s_cmpk_lt_u32
    case 0x0e: cmp(spv::Op::OpULessThanEqual, false); break;    // s_cmpk_le_u32
    ...
    case 0x12: t.SetSg(sdst, t.U32(0)); WarnUnsupported("sopk", op); break;
    case 0x13: break;
    default: WarnUnsupported("sopk", op); break;
  }
}
...
void EmitVop1(Translator& t, uint32_t op, uint32_t vdst, Id s0, bool clamp) {
  ...
  switch (op) {
    case 0x00: break;                 // v_nop
    case 0x01: set_u(u0); break;      // v_mov_b32
    case 0x02: set_u(u0); break;      // v_readfirstlane_b32 (single lane)
    case 0x05:                        // v_cvt_f32_i32
      set_f(t.m.Emit(spv::Op::OpConvertSToF, t.t_f, {t.m.Bitcast(t.t_i, u0)}));
      break;
    case 0x06: set_f(t.m.Emit(spv::Op::OpConvertUToF, t.t_f, {u0})); break;  // cvt_f32_u32
    case 0x07: set_u(t.m.Emit(spv::Op::OpConvertFToU, t.t_u, {s0})); break;  // cvt_u32_f32
    ...
    case 0x20: set_f(t.Ext1(GLSLstd450Fract, s0)); break;      // v_fract_f32
    case 0x21: set_f(t.Ext1(GLSLstd450Trunc, s0)); break;      // v_trunc_f32
    case 0x22: set_f(t.Ext1(GLSLstd450Ceil, s0)); break;       // v_ceil_f32
    case 0x23: set_f(t.Ext1(GLSLstd450RoundEven, s0)); break;  // v_rndne_f32
    case 0x24: set_f(t.Ext1(GLSLstd450Floor, s0)); break;      // v_floor_f32
    case 0x25: set_f(t.Ext1(GLSLstd450Exp2, s0)); break;       // v_exp_f32
    case 0x26: case 0x27: set_f(t.Ext1(GLSLstd450Log2, s0)); break;  // v_log[_clamp]_f32
    case 0x28: case 0x29: case 0x2a: case 0x2b:
      set_f(t.FDiv(t.F32(1.0f), s0)); break;  // v_rcp[_clamp/legacy/iflag]_f32
    case 0x2c: case 0x2d: case 0x2e:
      set_f(t.Ext1(GLSLstd450InverseSqrt, s0)); break;  // v_rsq[_clamp/legacy]_f32
    case 0x33: set_f(t.Ext1(GLSLstd450Sqrt, s0)); break;  // v_sqrt_f32
    // GCN trig takes the argument in revolutions (1.0 == 2*pi).
    case 0x35: set_f(t.Ext1(GLSLstd450Sin, t.FMul(s0, t.F32(6.28318530718f)))); break;
    case 0x36: set_f(t.Ext1(GLSLstd450Cos, t.FMul(s0, t.F32(6.28318530718f)))); break;
    case 0x37: set_u(t.Not(u0)); break;     // v_not_b32
    case 0x38: set_u(t.BitRev(u0)); break;  // v_bfrev_b32
    ...
    case 0x3a: set_u(t.m.ExtInst(t.t_u, GLSLstd450FindILsb, {u0})); break;  // v_ffbl_b32
    case 0x3b: {  // v_ffbh_i32: leading-sign-bit count; -1 if src is 0 or -1
      const Id smsb = t.m.Bitcast(
          t.t_u, t.m.ExtInst(t.t_i, GLSLstd450FindSMsb, {t.m.Bitcast(t.t_i, u0)}));
...
void EmitVop2(Translator& t, uint32_t op, uint32_t vdst, Id s0, Id s1,
  ...
  switch (op) {
    ...
    case 0x01: case 0x02: set_u(u0); break;
    case 0x03: set_f(t.FAdd(s0, s1)); break;  // v_add_f32
    case 0x04: set_f(t.FSub(s0, s1)); break;  // v_sub_f32
    case 0x05: set_f(t.FSub(s1, s0)); break;  // v_subrev_f32
    case 0x06: set_f(t.FAdd(t.FMul(s0, s1), t.VgF(vdst))); break;  // v_mac_legacy_f32
    case 0x07: case 0x08: set_f(t.FMul(s0, s1)); break;  // v_mul[_legacy]_f32
    case 0x09: set_u(t.Mul(t.Sext24(u0), t.Sext24(u1))); break;  // v_mul_i32_i24
    case 0x0a:  // v_mul_hi_i32_i24
      set_u(mul24_hi(spv::Op::OpSMulExtended, t.Sext24(u0), t.Sext24(u1)));
      break;
    case 0x0b: set_u(t.Mul(t.Low24(u0), t.Low24(u1))); break;  // v_mul_u32_u24
    case 0x0c:  // v_mul_hi_u32_u24
      set_u(mul24_hi(spv::Op::OpUMulExtended, t.Low24(u0), t.Low24(u1)));
      break;
    case 0x0d: case 0x0f: set_f(t.Ext2(GLSLstd450FMin, s0, s1)); break;  // v_min[_legacy]_f32
    case 0x0e: case 0x10: set_f(t.Ext2(GLSLstd450FMax, s0, s1)); break;  // v_max[_legacy]_f32
    case 0x11: set_u(t.SMin(u0, u1)); break;  // v_min_i32
    case 0x12: set_u(t.SMax(u0, u1)); break;  // v_max_i32
    case 0x13: set_u(t.UMin(u0, u1)); break;  // v_min_u32
    case 0x14: set_u(t.UMax(u0, u1)); break;  // v_max_u32
    case 0x15: set_u(t.Shr(u0, u1)); break;   // v_lshr_b32
    case 0x16: set_u(t.Shr(u1, u0)); break;   // v_lshrrev_b32
    case 0x17: set_u(t.Sar(u0, u1)); break;   // v_ashr_i32
    case 0x18: set_u(t.Sar(u1, u0)); break;   // v_ashrrev_i32
    case 0x19: set_u(t.Shl(u0, u1)); break;   // v_lshl_b32
    case 0x1a: set_u(t.Shl(u1, u0)); break;   // v_lshlrev_b32
    case 0x1b: set_u(t.And(u0, u1)); break;   // v_and_b32
    case 0x1c: set_u(t.Or(u0, u1)); break;    // v_or_b32
    case 0x1d: set_u(t.Xor(u0, u1)); break;   // v_xor_b32
    case 0x1e: {  // v_bfm_b32: ((1 << s0[4:0]) - 1) << s1[4:0]
      const Id ones = t.Sub(t.Shl(t.U32(1), u0), t.U32(1));
      set_u(t.Shl(ones, u1));
      break;
    }
    case 0x1f: set_f(t.FAdd(t.FMul(s0, s1), t.VgF(vdst))); break;  // v_mac_f32
...
Id FloatPredicate(Translator& t, uint32_t lo, Id a, Id b) {
  ...
  const auto is_nan = [&](Id x) { return t.m.Emit(spv::Op::OpIsNan, t.t_bool, {x}); };
  switch (lo) {
    case 1: return F(spv::Op::OpFOrdLessThan);
    case 2: return F(spv::Op::OpFOrdEqual);
    case 3: return F(spv::Op::OpFOrdLessThanEqual);
    case 4: return F(spv::Op::OpFOrdGreaterThan);
    case 5: return F(spv::Op::OpFOrdNotEqual);            // LG
    case 6: return F(spv::Op::OpFOrdGreaterThanEqual);
    case 7:  // O: neither operand NaN
      return t.m.Emit(spv::Op::OpLogicalNot, t.t_bool,
    ...
    case 9: return F(spv::Op::OpFUnordLessThan);          // NGE
    case 10: return F(spv::Op::OpFUnordEqual);            // NLG
    case 11: return F(spv::Op::OpFUnordLessThanEqual);    // NGT
    case 12: return F(spv::Op::OpFUnordGreaterThan);      // NLE
    case 13: return F(spv::Op::OpFUnordNotEqual);         // NEQ
    case 14: return F(spv::Op::OpFUnordGreaterThanEqual); // NLT
    case 15: return t.m.ConstBool(true);                  // TRU
    default: return 0;                                    // F (always false)
  }
}
...
Id IntPredicate(Translator& t, uint32_t lo, bool is_signed, Id a, Id b) {
  ...
  switch (lo) {
    case 1: return is_signed ? S(spv::Op::OpSLessThan) : U(spv::Op::OpULessThan);
    case 2: return t.Eq(a, b);
    case 3: return is_signed ? S(spv::Op::OpSLessThanEqual) : U(spv::Op::OpULessThanEqual);
    case 4: return is_signed ? S(spv::Op::OpSGreaterThan) : U(spv::Op::OpUGreaterThan);
    case 5: return t.m.Emit(spv::Op::OpINotEqual, t.t_bool, {a, b});
    case 6: return is_signed ? S(spv::Op::OpSGreaterThanEqual) : U(spv::Op::OpUGreaterThanEqual);
...
void EmitVopc(Translator& t, uint32_t op, Id s0f, Id s1f, Id s0u, Id s1u,
  ...
  Id cond = 0;
  if (op <= 0x3F) {
    if (op >= 0x20) WarnUnsupported("vopc.f64", op);
  ...
  t.SetSg(dst, result);
  if (op & 0x10) t.SetSg(126, result);  // cmpx: replace EXEC
}
...
void EmitVop3(Translator& t, uint32_t op, uint32_t vdst, Id s0, Id s1, Id s2,
  ...
  const auto mul_hi = [&](spv::Op wide_mul) {  // high 32 bits of the product
    return t.m.CompositeExtract(
        t.t_u, t.m.Emit(wide_mul, t.PairType(), {u0, u1}), 1);
  };
  // Median of 3 (no GLSL medN): max(min(a,b), min(max(a,b), c)).
  const auto med3 = [&](Id (Translator::*mn)(Id, Id), Id (Translator::*mx)(Id, Id)) {
  ...
  switch (op) {
    ...
    case 0x149:  // v_bfe_i32
      set_u(t.m.Bitcast(t.t_u, t.m.Emit(spv::Op::OpBitFieldSExtract, t.t_i,
            {t.m.Bitcast(t.t_i, u0), t.And(u1, t.U32(31)), t.And(u2, t.U32(31))})));
      break;
    ...
    case 0x144: case 0x145: case 0x146: case 0x147: {  // v_cube{id,sc,tc,ma}_f32
      ...
      const Id z_ge_x = t.m.Emit(spv::Op::OpFOrdGreaterThanEqual, t.t_bool, {az, ax});
      const Id z_ge_y = t.m.Emit(spv::Op::OpFOrdGreaterThanEqual, t.t_bool, {az, ay});
      const Id z_major = t.LAnd(z_ge_x, z_ge_y);
      const Id y_ge_x = t.m.Emit(spv::Op::OpFOrdGreaterThanEqual, t.t_bool, {ay, ax});
      const Id not_z = t.m.Emit(spv::Op::OpLogicalNot, t.t_bool, {z_major});
      const Id y_major = t.LAnd(not_z, y_ge_x);
      const Id x_neg = t.m.Emit(spv::Op::OpFOrdLessThan, t.t_bool, {s0, t.F32(0.0f)});
      const Id y_neg = t.m.Emit(spv::Op::OpFOrdLessThan, t.t_bool, {s1, t.F32(0.0f)});
      const Id z_neg = t.m.Emit(spv::Op::OpFOrdLessThan, t.t_bool, {s2, t.F32(0.0f)});
    ...
    case 0x14d: {  // v_lerp_u8: per-byte (a + b + (c & 1)) >> 1
      ...
      for (int b = 0; b < 4; b++) {
        ...
        const Id a = t.And(t.Shr(u0, sh), mask), bb = t.And(t.Shr(u1, sh), mask);
    ...
    case 0x14e: {  // v_alignbit_b32: ({S0,S1} >> S2[4:0])[31:0] (S0 hi, S1 lo)
      ...
      const Id hi = t.SelectB(t.IsZero(sh), t.U32(0), t.Shl(u0, t.Sub(t.U32(32), sh)));
      set_u(t.Or(lo, hi));
      break;
    }
    ...
    case 0x151: set_f(t.Ext2(GLSLstd450FMin, t.Ext2(GLSLstd450FMin, s0, s1), s2)); break;  // v_min3_f32
    case 0x152: set_u(t.SMin(t.SMin(u0, u1), u2)); break;  // v_min3_i32
    case 0x153: set_u(t.UMin(t.UMin(u0, u1), u2)); break;  // v_min3_u32
    case 0x154: set_f(t.Ext2(GLSLstd450FMax, t.Ext2(GLSLstd450FMax, s0, s1), s2)); break;  // v_max3_f32
    case 0x155: set_u(t.SMax(t.SMax(u0, u1), u2)); break;  // v_max3_i32
    case 0x156: set_u(t.UMax(t.UMax(u0, u1), u2)); break;  // v_max3_u32
    ...
    case 0x158: set_u(med3(&Translator::SMin, &Translator::SMax)); break;  // v_med3_i32
    case 0x159: set_u(med3(&Translator::UMin, &Translator::UMax)); break;  // v_med3_u32
    ...
    // ignores.
    case 0x15f: set_f(t.FDiv(s2, s1)); break;  // v_div_fixup_f32
    case 0x16d:                                // v_div_scale_f32: identity
      set_f(s0);
      t.SetSg(sdst, t.U32(0));
      break;
    case 0x16f: set_f(t.FAdd(t.FMul(s0, s1), s2)); break;  // v_div_fmas_f32
    case 0x169: case 0x16b: set_u(t.Mul(u0, u1)); break;   // v_mul_lo_u32/i32
    case 0x16a: set_u(mul_hi(spv::Op::OpUMulExtended)); break;  // v_mul_hi_u32
    case 0x16c: set_u(mul_hi(spv::Op::OpSMulExtended)); break;  // v_mul_hi_i32
    case 0x161: case 0x162: case 0x163: {  // v_lshl/lshr/ashr_b64 (low result)
    ...
    case 0x176: case 0x177: {  // v_mad_u64_u32 / v_mad_i64_i32
      ...
      set_u(lo.value);
      if (vdst + 1 < 256) t.SetVg(vdst + 1, hi.value);
      Id bit64 = hi.flag;
      if (sgn)
        bit64 = t.Xor(bit64, t.Xor(t.Xor(t.Shr(p_hi, t.U32(31)),
                                         t.Shr(s2_hi, t.U32(31))),
