...
// Where a frame's wall time goes: the accumulators every unit in the module
// feeds, and the clock they are fed from. Reporting them is
// vulkan/vk_perf.h's job; this header deliberately depends on nothing so a
